...
from cutie.utils.get_default_model import get_default_model, get_my_model
...
def main():
    ...
    mask = Image.open('./examples/masks/judo/00000.png')
    ...
    for ti, image_name in enumerate(images):
        ...
        mask.save(f'./examples/masks/bike/{ti+1:05d}.png')
